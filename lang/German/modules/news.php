...
define('OGP_LANG_sure_to_delete', "Sind Sie sicher, diesen Eintrag zu löschen?");
...
define('OGP_LANG_enable_search', "Suchmaschine aktivieren");
...
define('OGP_LANG_id_invalid', "Diese News ID existiert nicht");
define('OGP_LANG_id_not_set', "Die News ID wurde nicht gesetzt");
define('OGP_LANG_unauthorized_access', "Unautorisierter Zugriff von");
define('OGP_LANG_wysiwyg', "WYSIWYG Editor");
define('OGP_LANG_tinymce_lang', "Tiny MCE Sprache");
...
define('OGP_LANG_safe_HTML_en', "HTML Purifier aktiviert");
define('OGP_LANG_safe_HTML_dis', "HTML Purifier deaktiviert");

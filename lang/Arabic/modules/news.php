...
define('written_by', "كتب بواسطة");
define('details', "اقرأ المزيد");
define('modify', "تعديل");
define('save', "حفظ");
define('delete', "حذف");
define('sure_to_delete', "هل تريد بالتأكيد حذف هذه الأخبار؟");
define('go_back', "إرجع");
define('new_added_success', "تم نشر الأخبار بنجاح!");
define('add_another', "إضافة عنصر آخر");
define('or_message', "أو");
define('please_select', "الرجاء الاختيار");
define('submit', "Submit");
define('edit_listing', "تعديل الأخبار");
...
define('permission_ok', "Required permissions are all OK!");
...
define('da', "Danish");
define('de', "German");
define('en_GB', "English");
define('es', "Spanish");
define('fi', "Finnish");
define('fr_FR', "French");
define('it', "Italian");
define('pl', "Polish");
define('pt_PT', "Portuguese");
define('ru', "Russian");
